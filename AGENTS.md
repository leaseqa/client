...
When changing AI review, RAG UX, uploads, citations, or guest-vs-auth behavior:

- review `README.md`
- review `docs/product-prd.md`
- review `docs/architecture.md`
- review `docs/api-design.md`
- review `docs/release-checklist.md`

When changing auth, account, activity, notifications, or saved-history behavior:
...
When changing Q&A, discussions, moderation, or admin UI:
...
Do not treat client feature work as complete until documentation impact has been checked against the canonical docs above.
