...
LeaseQA is a renter-facing web app for Boston housing questions, lease review, account history, and community moderation workflows.
...
When the answer relies on housing-law guidance, the UI expects handbook support rather than only showing the uploaded source.
