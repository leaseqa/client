    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8">
      <div className="grid gap-5 lg:grid-cols-[260px_1fr]">
        <aside className="space-y-4">
          ...
          <div className="rounded-2xl border border-white/5 bg-[var(--app-panel)] p-4 text-sm text-slate-300">
            ...
            <ul className="mt-3 space-y-2">
              <li>
                <button className="w-full rounded-xl border border-white/10 px-3 py-2 text-left text-xs text-slate-200 hover:bg-white/5">
                  Follow thread
                </button>
              </li>
              <li>
        ...
        <div className="space-y-6">
          <article className="rounded-2xl border border-white/5 bg-[var(--app-panel)] p-6 shadow-lg shadow-black/20">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3 text-sm text-slate-400">
              ...
              <button className="text-xs font-medium text-[var(--accent-cyan)] hover:underline">Edit</button>
              <button className="text-xs font-medium text-[var(--accent-cyan)] hover:underline">More actions</button>
            </div>
            <div
